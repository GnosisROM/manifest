...
GnosisROM. Google recommends using [Ubuntu](http://www.ubuntu.com/download/desktop) for
...
$ repo init -u https://github.com/GnosisROM/manifest -b 11
```
...
# For example, enter GnosisROM/android_frameworks_base or
...
author/authors (GnosisROM) and inform about any changes that have been
made.
